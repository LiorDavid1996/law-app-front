  ...
  return (
    <Container className="d-flex mt-5 main-container">
      <Col sm={6} className="mt-4">
        <h1>Why businesses</h1><h1>turn to Gold Law</h1>
        <Row className="mt-4">
          <Col>
        ...
        <Row className="mt-4">
          ...
          <Col>
            <Row className="align-items-baseline">
              ...
              <Col sm={11}>
                <h3>Search or shortlist</h3>
                <h5 className="text-muted">
                  Find talent yourself, or talk to a recruiter to get a
                  shortlist of pre-vetted talent within 2 days.*
                </h5>
              </Col>
            </Row>
          </Col>
